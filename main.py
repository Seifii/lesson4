...
class superevil:
    count_evil = 0
    def __init__(self, height = 200, power = 900, speed = 100):
        self.power = power
        self.speed = speed
        self.height = height
        superevil.count_evil += 1

joker = superevil(height = 180, power = 800, speed = 150)
print("joker")
print(joker.height)
print(joker.power)
print(joker.speed)

penguin = superevil(height= 150, power = 950, speed = 95)
print("penguin")
print(penguin.height)
print(penguin.power)
print(penguin.speed)

harley_queen = superevil(height= 170, speed = 125)
print("harley queen")
print(harley_queen.height)
print(harley_queen.power)
print(harley_queen.speed)
...
print("Count super - ", superhero.count_super)

print("Count evil - ", superevil.count_evil)
